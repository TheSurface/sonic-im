...
if sonic_im_client == 'Keeps':
    ...
    ### VIEWS: Monthly Calendar View ###
        ...
        # Create lead and purchase calendar dataframes
        df_final_output = pd.merge(df_base_budget, df_budget[['event_date','created_week','created_month','Actual Drop Day']],how='left',left_on=['Show Name'],right_on=['created_month','Show Name'])
