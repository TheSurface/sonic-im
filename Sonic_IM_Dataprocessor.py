...
if sonic_im_client == 'Keeps':
    ...
    ### VIEWS: Monthly Calendar View ###
        ...
        df_budget_grouped = df_budget[df_budget['Broadcast Week'] <= cutoff_date].groupby(['Show Name','budget_spend_month','Estimated Purchases','Actual Drop Day']).sum()[['Client Rate']].reset_index()
